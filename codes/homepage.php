...
// Construct the SQL query with a WHERE clause to filter by the search term using a prepared statement  
$query = "SELECT * FROM hotels WHERE hotelName LIKE ? OR hotelAddress LIKE ?";  
...
$arrResult = array(); // Initialize the array to store the search results  
