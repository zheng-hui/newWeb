...
if($pic_uploaded == 1) {
    ...
    if (isset($_FILES['profile_photo'])) {
        ...
        if (!in_array($file_extension, $allowed_extensions)) {
            ...
            $error_message = "Please upload a photo with .jpg/.jpeg/.png/ extension";
            $pic_uploaded = 0;
        }
    }

    if ($file_size > 3000000) { // 3 MB (size in bytes)
        // File size exceeds the limit
        $error_message = "Your photo exceeds the size of 3 MB";
        $pic_uploaded = 0;
    }
...
<nav class="navbar navbar-expand-sm p-3 mb-2 navbar-custom">
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="collapsibleNavbar">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link" href="homepage.php"><span class="text-white">Hotels</span></a>
                </li>
                <li class="nav-item">
...
<?php
                        if (isset($_SESSION['userId'])) {
                            ?>
                            <a class="nav-link" href="logout.php"><span class="text-white">Logout</span></a>
                        <?php } else { ?>
                            <a class="nav-link" href="login.php"><span class="text-white">Login/Register</span></a>
                        <?php } ?>
                    </li>
                </div>
            </ul>
